    ...
    public void Solve()
    {
        ...
        for (int len = 0; len < N; len++)
        {
            for (int begin = 0; begin + len <= N; begin++)
            {
                ...
                if (begin + len + 1 <= N)
                {
                    if (begin + len >= M || T[begin + len] == S[len])
                    {
                        dp[begin, begin + len + 1] += dp[begin, begin + len];
                    }
                }
                ...
                if (begin > 0)
                {
                    if (begin - 1 >= M || T[begin - 1] == S[len])
                    {
                        dp[begin - 1, begin + len] += dp[begin, begin + len];
                    }
                }
            }
        }
