...
public class Program
{
    ...
    public void Solve()
    {
        ...
        // 回答セットがある
        // 正しく入れたときの点数 < 1つずらして入れたときの点数 なセットの数
        ...
        {
            ModInt tmp = C(dCnt, z) * ModInt.Pow(K - 2, z);
    ...
    ModInt A(int n)
    {
        if (n % 2 == 0)
        {
            return (ModInt.Pow(2, n) - C(n, n / 2))*ModInt.Inverse(2);
        }
        else
        {
            return ModInt.Pow(2,n)*ModInt.Inverse(2);
        }
    }
