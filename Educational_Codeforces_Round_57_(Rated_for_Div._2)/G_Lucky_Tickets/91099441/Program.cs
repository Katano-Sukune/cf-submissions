...
public class Program
{
    ...
    public void Solve()
    {
        ...
        ModInt[] a = new ModInt[Len];
        a[0] = 1;

        ModInt[] b = new ModInt[Len];
        for (int i = 0; i < k; i++)
        {
            b[sc.NextInt()] = 1;
        }
        ModInt invLen = ModInt.Inverse(Len);
        FastFourierTransform.Transform(a, Lg, Len, false);
        FastFourierTransform.Transform(b, Lg, Len, false);
        ...
        FastFourierTransform.Transform(a, Lg, Len, true);
        for (int i = 0; i < Len; i++)
        {
            a[i] *= invLen;
        }
...
namespace CompLib.Algorithm
{
    ...
    public static class FastFourierTransform
    {
        ...
        /// <param name="b"></param>
        /// <returns></returns>
        public static void Convolution(ref ModInt[] a, ModInt[] b)
        {
