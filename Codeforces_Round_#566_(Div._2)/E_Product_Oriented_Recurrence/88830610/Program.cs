...
public class Program
{
    ...
    public void Solve()
    {
        ...
        var aC = new Matrix(1, 5);
        aC[0, 3] = 2;
        aC[0, 4] = 2;
        var bC = new Matrix(5, 5);
        bC[1, 0] = 1;
        bC[2, 1] = 1;
        bC[0, 2] = 1;
        bC[1, 2] = 1;
        ...
        b[1, 2] = 1;
        b[2, 2] = 1;
        var c = Matrix.Pow(b, N - 3);
        // F1がいくつか
        var a1 = new Matrix(1, 3);
        a1[0, 0] = 1;
        var d1 = a1 * c;
        long cntF1 = d1[0, 2];

        var a2 = new Matrix(1, 3);
        a2[0, 1] = 1;
        var d2 = a2 * c;
        long cntF2 = d2[0, 2];

        var a3 = new Matrix(1, 3);
        a3[0, 2] = 1;
        var d3 = a3 * c;
        long cntF3 = d3[0, 2];
        ModInt ans = 1;
        ans *= ModInt.Pow(C, cntC);
        ans *= ModInt.Pow(F1, cntF1);
        ans *= ModInt.Pow(F2, cntF2);
        ans *= ModInt.Pow(F3, cntF3);
