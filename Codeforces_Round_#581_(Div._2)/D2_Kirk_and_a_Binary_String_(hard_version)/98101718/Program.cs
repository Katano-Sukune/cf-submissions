...
public class Program
{
    ...
    public void Solve()
    {
        ...
        // max (0の個数,1の個数,0000...1111...)

        (int o, int i, int oi)[] ar = new (int o, int i, int oi)[N];
        for (int i = 0; i < N; i++)
        {
            if (S[i] == '1') ar[i] = (0, 1, 1);
            else ar[i] = (1, 0, 1);
        ...
        var st = new SegmentTree<(int o, int i, int oi)>(ar,
            (l, r) => (l.o + r.o, l.i + r.i, Math.Max(l.o + r.oi, l.oi + r.i)),
            (0, 0, 0));
